...
/**
 * Platform hook to keep the system bar icons legible when the in-app theme override diverges
 * from the device theme. Android drives the window insets controller; iOS is a no-op (the shell
 * owns its status bar style).
 */
@Composable
