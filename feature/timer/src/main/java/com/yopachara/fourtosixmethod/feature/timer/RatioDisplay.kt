...
@Composable
fun RatioDisplay(timerDisplayState: TimerDisplayState, setRatioChange: (Int) -> Unit) {
    ...
    Column(
        ...
        Text(
            text = "1:${timerDisplayState.recipe.ratio.toString()}",
            fontSize = 32.sp,
...
fun PreviewRatioDisplay() {
    RatioDisplay(timerDisplayState = TimerDisplayState()) {}
}